...
class TCScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<CardModel> options = [
      CardModel(title: AppLocalizations.of(context)!.termsAndConditions, icon: BoxIcons.bx_book, onTap: (){
      ...
      CardModel(title: AppLocalizations.of(context)!.privacyPolicies, icon: BoxIcons.bx_shield, onTap: (){
        showModalBottomSheet<void>(
          isScrollControlled: true,
            context: context,
            builder: (BuildContext context) {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
              Column(
                children: [
                  ...List.generate(options.length, (index) => CardOption(options[index],),
                ),
              ]              
            )
          ],
